/* // # prosedur
?   adalah konsep yang ada pada paradigma pemrograman prosedural
?   yang memisahkan kode menjadi bagian-bagian yang lebih kecil sehingga meudah untuk dikelola
?   Prosedur adalah jenis fungsi yang dapat mengubah nilai dari variabel yang dilewatkan sebagai parameter.


    ! prosedur dalam bahasa C diimplementasikan menggunakan fungsi, dengan type kembalian void. 
    ! dan tidak mengembalikan nilai apapun 

    *kompoen-komponen prosedur
    -deklarasi fungsi
    -implementasi fungsi
    -pemanggilan fungsi
    -return value
